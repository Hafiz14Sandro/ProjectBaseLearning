...
$tglTerakhir = 12;
 ...
 <table width="100%">
 	<tr>
 		<td>
 			<img src="../../../assets/img/ti.jpg" width="130">
 		</td>
 		<td>
 			<center>
 				...
 				<hr>
 				<em>
				 Kampus Politeknik Negeri Padang Limau Manis<br> Kota Padang
Prov. Sumatera Barat
Indonesia, Kode Pos (21562) <br>
 				<b>Email : www.pnp.ac.idm Telp.0751-72590
