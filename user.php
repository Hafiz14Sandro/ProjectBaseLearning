        ...
        <div class="main-header" style="background-color: #1269DB;">
            ...
            <div class="container">
                <div class="logo-header" data-background-color="blue2">
                    ...
                    <a href="index.php">
                        <img src="assets/img/ti.jpg" alt="navbar brand" class="navbar-brand" width="40">
                    ...
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">Teknologi Informasi</h2>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <ul class="nav nav-pills nav-secondary  nav-pills-no-bd nav-pills-icons justify-content-center"
                                        ...
                                        <!-- <li class="nav-item">
											<a class="nav-linklink" href="view/admin.php">
    ...
    <footer class="footer">
        <div class="container">
            <div class="copyright ml-auto">
                &copy; <?php echo date('Y');?> PBL Kelompok 1 (<a href="index.php">Teknologi Inforamsi </a>
                | 2023)
            </div>
        </div>
    </footer>
