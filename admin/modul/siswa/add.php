                ...
                <div class="col-lg-8">
                  <div class="card">
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Form Tamabah Mahasiswa</h3>
                    </div>
                    <div class="card-body">
...
<table cellpadding="3" style="font-weight: bold;">
  ...
  <tr>
    <td>NIM</td>
    <td>:</td>
    <td><input name="nis" type="text" class="form-control" placeholder="Nomor induk Mahasiswa">	</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <tr>
    <td>Tahun Masuk</td>
    <td>:</td>
    <td><input name="th_masuk" type="number" class="form-control" placeholder="2020"></td>
  </tr>
  <tr>
    <td>Pas Foto</td>
    <td>:</td>
