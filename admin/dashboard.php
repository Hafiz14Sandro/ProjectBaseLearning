		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="red">
				...
				<a href="dashboard.php" class="logo">
					...
					<b class="text-white">Teknologi Informasi</b>
				</a>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="base">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=walas">
											<span class="sub-item"> Dosen PA </span>
										</a>
									</li>
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=kepsek&act=add ">
											<span class="sub-item"> Tambah Kaprodi </span>
										</a>
									</li>
									<li>
										<a href="?page=kepsek">
											<span class="sub-item"> Daftar Kaprodi </span>
										</a>
									</li>
								</ul>
							</div>
								...
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=rekap&kelas=<?=$k['id_mkelas'] ?> ">
											<span class="sub-item"> <?=strtoupper($k['nama_kelas']); ?></span>
										</a>
									</li>
								<?php } ?>
								</ul>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Presensi Teknologi Informasi (<a href="index.php">Kelompok 1</a> | 202)
					</div>				
				</div>
			</footer>
		</div>
